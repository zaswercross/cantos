let getHistory = () => {
    let registros = '<table><thead><th class="text-center">Folio</th><th>Fecha</th><th class="text-center">Nombre</th><th class="text-center">Teléfono</th><th class="text-center">Descripción</th><th>Precio</th><th class="text-center">Fecha Entrega</th><th class="text-center">Estatus</th></thead><tbody>';
